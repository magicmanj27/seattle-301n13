...
const testOneLiner = newWord => newWord.toUpperCase();

console.log('One-liner arrow function:', testOneLiner('new hello'));
...
// Student.prototype.greeting = (name) => `Hi, my name is ${this.name}`; this broke the code
...
// This refers to an instantiation of the Student object.
// 2. What is "this" when joe.scopeArrow() is invoked?
// This in the arrow function is the window object
// 3. Explain why "this" is different when an arrow function is used.
// This is different because of the bubbling up effect there is no containment because the this does not refer to the method's  inner function. 
