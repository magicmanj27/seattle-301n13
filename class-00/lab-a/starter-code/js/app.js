...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT. Rando is throwing an error because rando is block level and the scope of the variable is not visible outside of the while loop.
  console.log(viewed);
